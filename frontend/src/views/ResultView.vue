  ...
  <div class="container">
    <div class="page-header">
      ...
      <div style="display: flex; gap: 12px;">
        <button class="btn btn-secondary" @click="startOver" style="background: rgba(0,229,255,0.08); color: var(--primary); border: 1px solid rgba(0,229,255,0.2); font-weight: 600;">
          再来一篇
        </button>
      ...
      <div class="grid-cols-4">
        <div v-for="image in store.images" :key="image.index" class="image-card group">
          ...
          >
            ...
            <div v-if="regeneratingIndex === image.index" style="position: absolute; inset: 0; background: rgba(8, 12, 20, 0.85); display: flex; flex-direction: column; align-items: center; justify-content: center; z-index: 10;">
            ...
            <!-- Hover Overlay -->
            <div v-else style="position: absolute; inset: 0; background: rgba(0,0,0,0.3); opacity: 0; transition: opacity 0.2s; display: flex; align-items: center; justify-content: center; color: var(--text-main); font-weight: 600; pointer-events: none;" class="hover-overlay">
              预览大图
            </div>
          </div>
...
const viewImage = (url: string) => { lightboxUrl.value = url.split("?")[0] + "?thumbnail=false" }
