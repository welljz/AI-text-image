...
def create_outline_blueprint():
    ...
    def generate_outline():
        ...
        try:
            # 解析请求数据
            topic, images, page_count, style = _parse_outline_request()
            ...
            result = outline_service.generate_outline(topic, images if images else None, page_count, style)
...
def _parse_outline_request():
    if request.content_type and 'multipart/form-data' in request.content_type:
        ...
        page_count = int(request.form.get('page_count', 8))
        ...
        return topic, images, page_count, style
